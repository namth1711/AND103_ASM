...
public final class ActivityUpdateFruitBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityUpdateFruitBinding(@NonNull ScrollView rootView, @NonNull ImageView avatar,
  ...
  @NonNull
  public static ActivityUpdateFruitBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUpdateFruitBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_update_fruit, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUpdateFruitBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUpdateFruitBinding((ScrollView) rootView, avatar, btnBack, btnRegister,
